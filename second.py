...
# print(statement)
numerator1 =int(input ("x: "))
numerator2 =int(input ("a: "))
denominator1 = int(input ("y: "))
denominator2 = int(input ("b: "))
total_numerator = (numerator1*denominator2)+ (denominator1*numerator2)
total_denominator = (denominator1* denominator2)
value = f"{total_numerator} / {total_denominator}"
print(value)